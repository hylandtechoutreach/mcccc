# Page 2
Here is the real content for this session : - )

## Choose Your Own "Choose Your Own Adventure" Adventure
It's up to you to choose which text-based interactive experience you'd like to choose:
...
## Self-Paced Work
Work on the [self-paced work](SelfPacedWork.md) after the follow-along activity.
...
- [Documentation](https://twinery.org/cookbook/)
- [Interactive Fiction Database](https://ifdb.org/)
- [Interactive Fiction on itch.io](https://itch.io/games/tag-interactive-fiction)
